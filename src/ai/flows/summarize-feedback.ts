...
/**
 * @fileOverview Summarizes user feedback by category using AI.
 *
...
const SummarizeFeedbackOutputSchema = z.object({
  summary: z.string().describe('A summary of the user feedback by category.'),
});
...
const prompt = ai.definePrompt({
  ...
  Summarize the following user feedback by category. Identify the main issues and group similar feedback together. Provide a concise summary of each category.
